...
public class HashSetExample {
	...
	public static void main(String[] args) {
		...
		/*
		 - HashSet 클래스는 Set 인터페이스를 구현한 클래스입니다. 
		 	저장된 객체의 순서를 보장하지 않고, 중복 또한 허용하지 않습니다. 
		 - Set 인터페이스를 구현한 컬렉션 중 대표적으로 사용하는 클래스 중 하나입니다. 
		 */
		...
		set.add("단무지");
		set.add("김밥");
		set.add("김말이");//set은 중복 저장을 허용하지 않습니다.
		...
		/*
		 - Set의 객체 데이터를 검색하려면 반복자(Iterator)를 통해 모든 객체를 대상으로 한번씩 반복해서 꺼내봐야 합니다. 
		 */
		...
		System.out.println("==============================");
		/*
		 - 반복자 객체가 next()메서드를 통해 set의 내부 데이터를 반복 조회할때, 더이상 조회할 데이터가 없으면 예외를 발생시킵니다. 
